...
export const getOption = ({ props, state }) => (value) => {
  ...
  let newOption = { value: value, currentLabel: label }
...
export const setSelected = ({ api, constants, nextTick, props, refs, state }) => () => {
  ...
  if (!props.multiple) {
    if (isGrid || isTree) {
      ...
      const isRemote = props.filterable && props.remote && typeof props.remoteMethod === 'function'
...
export const nodeCheckClick = ({ emit, props, state }) => (data, { checkedKeys, checkedNodes }) => {
