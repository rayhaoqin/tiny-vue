...
export const computedRate = ({ constants, props }) => () =>
...
export const computedContent = ({ props }) => () =>
  typeof props.format === 'function' ? props.format(props.percentage) || '' : `${props.percentage}%`
