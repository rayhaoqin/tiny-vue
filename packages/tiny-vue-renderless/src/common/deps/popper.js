...
const isScrollElement = (parent) => {
  const scrollTypes = ['scroll', 'auto']

  return (
    ~scrollTypes.indexOf(getStyleComputedProperty(parent, 'overflow')) ||
    ~scrollTypes.indexOf(getStyleComputedProperty(parent, 'overflow-x')) ||
    ~scrollTypes.indexOf(getStyleComputedProperty(parent, 'overflow-y'))
  )
}
...
Popper.prototype._getOffsets = function (popper, reference, placement) {
  ...
  let { width, height } = getOuterSizes(popper)
...
Popper.prototype.modifiers.arrow = function (data) {
  ...
  let popperRect = getOuterSizes(this._popper)
